...
describe('metrics reducers', () => {
  ...
  describe('pinned card hydration', () => {
    ...
    // Resolving pins is done when tag metadata is loaded. Effects guarantee
    // that tag metadata loaded fires after the initial URL hydration.
    it('does not resolve imported pins', () => {
      const fakeMetadata = {
